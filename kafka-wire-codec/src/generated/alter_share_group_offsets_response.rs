    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        }
        {
            ...
            { let mut items = Vec::with_capacity(count.min(buf.len()));
                for _ in 0..count { items.push(AlterShareGroupOffsetsResponsePartition::decode(version, buf)?); }
...
impl AlterShareGroupOffsetsResponsePartition {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        let mut msg = AlterShareGroupOffsetsResponsePartition::default();
        {
...
impl AlterShareGroupOffsetsResponse {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        let mut msg = AlterShareGroupOffsetsResponse::default();
        {
        ...
        }
        {
            ...
            let count = len_opt.ok_or(DecodeError::NullForNonNullable)?;
            { let mut items = Vec::with_capacity(count.min(buf.len()));
                for _ in 0..count { items.push(AlterShareGroupOffsetsResponseTopic::decode(version, buf)?); }
            msg.responses = items; }
        }
        msg.tagged_fields = get_tagged_fields(buf)?;
        Ok(msg)
...
impl crate::Encodable for AlterShareGroupOffsetsResponse {
...
impl crate::EncodableZeroCopy for AlterShareGroupOffsetsResponse {

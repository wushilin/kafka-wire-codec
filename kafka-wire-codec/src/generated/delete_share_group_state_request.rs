...
impl DeleteStateData {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        let mut msg = DeleteStateData::default();
        {
...
impl DeleteShareGroupStateRequest {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        let mut msg = DeleteShareGroupStateRequest::default();
        {
        ...
        }
        {
            ...
            let count = len_opt.ok_or(DecodeError::NullForNonNullable)?;
            { let mut items = Vec::with_capacity(count.min(buf.len()));
                for _ in 0..count { items.push(DeleteStateData::decode(version, buf)?); }
            msg.topics = items; }
        }
        msg.tagged_fields = get_tagged_fields(buf)?;
        Ok(msg)
...
impl crate::Encodable for DeleteShareGroupStateRequest {
...
impl crate::EncodableZeroCopy for DeleteShareGroupStateRequest {

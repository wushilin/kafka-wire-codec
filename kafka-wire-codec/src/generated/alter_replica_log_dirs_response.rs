    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        }
        {
            ...
            { let mut items = Vec::with_capacity(count.min(buf.len()));
                for _ in 0..count { items.push(AlterReplicaLogDirPartitionResult::decode(version, buf)?); }
...
impl AlterReplicaLogDirPartitionResult {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        let mut msg = AlterReplicaLogDirPartitionResult::default();
        {
...
impl AlterReplicaLogDirsResponse {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        let mut msg = AlterReplicaLogDirsResponse::default();
        {
        ...
        }
        {
            ...
            let count = len_opt.ok_or(DecodeError::NullForNonNullable)?;
            { let mut items = Vec::with_capacity(count.min(buf.len()));
                for _ in 0..count { items.push(AlterReplicaLogDirTopicResult::decode(version, buf)?); }
            msg.results = items; }
        }
        if version >= 2 { msg.tagged_fields = get_tagged_fields(buf)?; }
        Ok(msg)
...
impl crate::Encodable for AlterReplicaLogDirsResponse {
...
impl crate::EncodableZeroCopy for AlterReplicaLogDirsResponse {

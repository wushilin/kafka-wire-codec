...
impl UnregisterBrokerResponse {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        let mut msg = UnregisterBrokerResponse::default();
        {
...
impl crate::Encodable for UnregisterBrokerResponse {
...
impl crate::EncodableZeroCopy for UnregisterBrokerResponse {

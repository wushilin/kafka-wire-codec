...
impl ShareGroupDescribeResponse {
    ...
    pub fn decode(version: i16, buf: &mut Bytes) -> Result<Self, DecodeError> {
        ...
        let mut msg = ShareGroupDescribeResponse::default();
        {
...
impl crate::Encodable for ShareGroupDescribeResponse {
...
impl crate::EncodableZeroCopy for ShareGroupDescribeResponse {
